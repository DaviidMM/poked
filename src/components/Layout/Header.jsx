...
export default function Header() {
  ...
  return (
    <header className="bg-red-600 py-10 flex flex-row relative items-center xl:justify-center px-12 text-red-900 border-b-[6px] border-black">
      ...
      <nav className="hidden xl:block">
        <ul className="flex flex-row gap-4">
          ...
          <NavItem to="type-calculator">Punto de intercambio</NavItem>
        </ul>
      </nav>
      <Link
        to="/settings"
