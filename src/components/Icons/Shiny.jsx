...
export default function ShinyIcon({ ...props }) {
  return (
    ...
    >
      <g>
        <path d="M19.42,44.8c11.92-8.43,19.3-18.14,23.34-24.64c4.04,6.5,11.42,16.2,23.34,24.64 c-11.91,8.43-19.3,18.13-23.34,24.63C38.73,62.94,31.34,53.23,19.42,44.8z" />
        <path d="M96.2,81.84c-2.5-3.16-6.54-7.36-12.52-11.23c5.98-3.87,10.01-8.07,12.52-11.23 c2.5,3.16,6.54,7.36,12.51,11.23C102.74,74.48,98.71,78.68,96.2,81.84z" />
        <path d="M63.71,110.4c-2.08-3.05-5.18-6.82-9.56-10.3c4.38-3.49,7.48-7.25,9.56-10.31 c2.08,3.05,5.18,6.82,9.56,10.31C68.89,103.58,65.79,107.35,63.71,110.4z" />
        <g>
          <path
